...
// TODO You need to replace all instances of "action-handler-airpurifier" with "action-handler-<your card name>"
customElements.define('action-handler-airpurifier', ActionHandler);

const getActionHandler = (): ActionHandler => {
  const body = document.body;
  if (body.querySelector('action-handler-airpurifier')) {
    return body.querySelector('action-handler-airpurifier') as ActionHandler;
  }

  const actionhandler = document.createElement('action-handler-airpurifier');
